...
const experiences: Experience[] = [
  {
    ...
    achievements: [
      "Increased user engagement for DTC platform",
      "Designed entirely inventory management system",
      "Re designed entirely website of Happychimps",
      "Update consumer app",
      "Improved loyalty flow design & other systems",
    ],
