    ...
    <div className="font-sans flex flex-col items-center py-16 px-4 sm:px-6 lg:px-8 text-gray-900 dark:text-white">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 w-full max-w-6xl">
        ...
        <div className="bg-white/80 dark:bg-black/50 p-8 rounded-xl flex flex-col justify-between border border-gray-200 dark:border-gray-800 backdrop-blur-sm shadow-md">
          <div className="mb-8">
            ...
            <p className="text-base sm:text-lg lg:text-xl text-gray-800 dark:text-gray-200 leading-relaxed mb-8">
              Working with this platform has dramatically improved our development cycle. The intuitive design tools and
              robust API integrations have allowed us to innovate faster and deliver high-quality solutions to our
              clients with unprecedented efficiency. It&apos;s truly a game-changer for modern software development.
            </p>
          </div>
          <div className="flex items-center">
            <img
              ...
              onError={(e: React.SyntheticEvent<HTMLImageElement, Event>) => {
                ...
                ;(e.target as HTMLImageElement).src = "https://placehold.co/48x48/6B7280/FFFFFF?text=ST"
              }}
            />
            <div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="bg-white/80 dark:bg-black/50 p-8 rounded-xl flex flex-col justify-between border border-gray-200 dark:border-gray-800 backdrop-blur-sm shadow-md">
            <p className="text-base sm:text-lg lg:text-xl text-gray-800 dark:text-gray-200 leading-relaxed mb-8">
              This framework is incredibly powerful and user-friendly. It eliminated so many headaches in our workflow,
              allowing us to focus on creativity rather than tedious setup. A truly invaluable asset for any developer.
            </p>
            <div className="flex items-center">
              <img
                ...
                onError={(e: React.SyntheticEvent<HTMLImageElement, Event>) => {
                  ;(e.target as HTMLImageElement).onerror = null
                  ;(e.target as HTMLImageElement).src = "https://placehold.co/48x48/6B7280/FFFFFF?text=JY"
                }}
              />
              <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="bg-white/80 dark:bg-black/50 p-6 rounded-xl flex flex-col justify-between border border-gray-200 dark:border-gray-800 backdrop-blur-sm shadow-md">
              <p className="text-sm sm:text-base text-gray-800 dark:text-gray-200 leading-relaxed mb-6">
                The templates provided here are top-notch. They&apos;ve saved me countless hours and the designs are
                simply stunning. Highly recommend for anyone building a personal website!
              </p>
              <div className="flex items-center">
                <img
                  ...
                  onError={(e: React.SyntheticEvent<HTMLImageElement, Event>) => {
                    ;(e.target as HTMLImageElement).onerror = null
                    ;(e.target as HTMLImageElement).src = "https://placehold.co/40x40/6B7280/FFFFFF?text=YF"
                  }}
                />
                <div>
            ...
            <div className="bg-white/80 dark:bg-black/50 p-6 rounded-xl flex flex-col justify-between border border-gray-200 dark:border-gray-800 backdrop-blur-sm shadow-md">
              <p className="text-sm sm:text-base text-gray-800 dark:text-gray-200 leading-relaxed mb-6">
                Exceptional quality and incredible attention to detail. This platform has truly elevated my web
                projects. The best personal website resource I&apos;ve come across!
              </p>
              <div className="flex items-center">
                <img
                  ...
                  onError={(e: React.SyntheticEvent<HTMLImageElement, Event>) => {
                    ;(e.target as HTMLImageElement).onerror = null
                    ;(e.target as HTMLImageElement).src = "https://placehold.co/40x40/6B7280/FFFFFF?text=RA"
                  }}
                />
                <div>
